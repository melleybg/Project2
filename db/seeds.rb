...
classic = Recipe.create!(name: "Classic", img_url:"https://greatist.com/sites/default/files/styles/article_main/public/1.%20Super%20Simple%20Guacamole.jpg?itok=MFzPHmye",  detail:"")
classic = Ingredient.create!(name: "Classic", img_url:"https://greatist.com/sites/default/files/styles/article_main/public/1.%20Super%20Simple%20Guacamole.jpg?itok=MFzPHmye",  detail:"5 spoon")

bougie = Recipe.create!(name: "Bougie", img_url:"https://greatist.com/sites/default/files/styles/article_main/public/8.%20Spicy%20Apple%20Guacamole.jpg?itok=L4B5IW7-",detail:"")
bougie = Ingredient.create!(name: "Bougie",img_url: "", detail:"")

tropicana = Recipe.create!(name: "Tropicana", img_url:"https://greatist.com/sites/default/files/styles/article_main/public/6.%20Tropical%20Fruit%20Guacamole.jpeg?itok=jQGSAvbu",detail:"")
tropicana = Ingredient.create!(name: "Tropicana", img_url: "", detail:"")

pomi = Recipe.create!(name: "Pomi", img_url:"https://greatist.com/sites/default/files/styles/article_main/public/10.%20Pomegranate%20Guacamole.jpg?itok=9KvmRoyt",detail:"")
pomi = Ingredient.create!(name: "Pomi", img_url: "", detail:"")
